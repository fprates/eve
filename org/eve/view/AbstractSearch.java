...
public abstract class AbstractSearch implements Search {
    ...
    protected final String getMessage(String message) {
        return getController().getMessages().getMessage(
                message, null, message, locale);
    }
    ...
    /*
     * (non-Javadoc)
     * @see org.eve.view.Search#setFactory(
     *     org.eve.view.AbstractComponentFactory)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.eve.view.Search#define(
     *     org.eve.view.Component, org.eclipse.swt.widgets.Composite)
     */
    @Override
